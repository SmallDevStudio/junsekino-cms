  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <div className="mt-1 text-[11px] text-[var(--admin-muted)]">
                Used as the primary image for {contentLabel.toLowerCase()}{" "}
          ...
          <div className="mt-3">
            {featuredImage ? (
              ...
              <EmptyMedia
                ...
                description={`Select an image from Media Library to represent this ${contentLabel.toLowerCase()}.`}
          ...
          <div className="mt-3">
            {gallery.length === 0 ? (
              <EmptyMedia
                ...
                description={`Add one or more images from Media Library to build the ${contentLabel.toLowerCase()} gallery.`}
      ...
      <MediaPicker
        ...
        multiple={false}
        title={`Select ${contentLabel.toLowerCase()} cover`}
      ...
      <MediaPicker
        ...
        multiple
        title={`Select ${contentLabel.toLowerCase()} gallery`}
