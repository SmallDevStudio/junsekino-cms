...
import { unpublishPerson } from "@/modules/people/people.service";
...
export async function POST(request, context) {
  try {
    ...
    const result = await unpublishPerson({
      companyId: company.data,
    ...
    console.error("Unpublish people error:", error);
    ...
    return NextResponse.json(
      {
        success: false,
        message: "Unable to unpublish people record.",
      },
      {
        status: 500,
      },
